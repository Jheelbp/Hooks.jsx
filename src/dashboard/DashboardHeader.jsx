            ...
            <div className='flex flex-col justify-evenly w-4/5'>
                ...
                <div className=' flex-wrap md:flex w-4/5 justify-between'>
                    <div className='flex gap-3 items-center'>
                        <img src="./dashboard_image/cloud.png" alt="" />
                        <span className='md:text-3xl font-bold'>314,519</span>
                        <span>MTCO2e</span>
                    </div>
                    <div  className='flex gap-3 items-center'>
                        <img src="./dashboard_image/earth.png" alt="" />
                        <span className='md:text-3xl font-bold'>314,519</span>
                        <span>MTCO2e</span>
                    </div>
                    <div  className='flex gap-3 items-center'>
                        <img src="./dashboard_image/plant.png" alt="" />
                        <span className='md:text-3xl font-bold'>314,519</span>
                        <span>MTCO2e</span>
                    </div>
                </div>
            </div>
            <img src="./dashboard_image/city.png" alt="" className='w-80 h-36 ' />
        </div>
    )
}
